...
export function FrameCard({ data, selected }: NodeProps) {
  ...
  return <div className={`frame-card ${selected ? "selected" : ""}`} style={{ borderColor: frame.color, backgroundColor: `${frame.color}18` }}>
    <Handle id="frame-input" type="target" position={Position.Left} className="frame-edge-handle" />
    <Handle id="frame-output" type="source" position={Position.Right} className="frame-edge-handle" />
